    ...
    <div className="prose !max-w-none prose-lg">
      {currentPhase === "0" && (
        <>
          {userExplanationType === "none" ? (
            <>
              <p>In this phase of the experiment you will be presented with:</p>
              ...
              <p>
                ...
                yourself. This may or may not be the same as the prediction of
                the AI. After submitting your response, you will receive
                feedback in the form of the true sales prices.
              </p>
            </>
          ) : (
            <>
              ...
              <p>
                ...
                yourself. This may or may not be the same as the prediction of
                the AI. After submitting your response, you will receive
                feedback in the form of the <strong>true sales price</strong>.
              </p>
              {["point"].includes(userExplanationType) ? (
                <p>
                  {/* <strong>Why does the model predict this price for this property?</strong>  */}
                  <strong>Why is this property so expensive?</strong> We want to
              ...
              {["featureImportance"].includes(userExplanationType) ? (
                <p>
                  <strong>
                    Why does the model predict this price for this property?
                  </strong>
          ...
          {userExplanationType === "none" ? (
            <>
              ...
              <p>
                ...
                Your task is to{" "}
                <strong>estimate the house{"'"}s true sales price</strong> and{" "}
                <strong>the sales price that the AI predicts</strong>. After
                submitting your response, you will see:
              </p>
              <ul class="ps-10 mt-2 list-disc list-inside space-y-2">
      ...
      {currentPhase === "2" && (
        <>
          ...
          <p>
            For some properties not all information will be available, shown as{" "}
            {'"???"'}. For each house, your task is to{" "}
            <strong>choose an agent, either the AI or yourself</strong>, to
            predict the house’s true sales price. If you choose not to follow
            the AI, you will be asked to enter your prediction of the house
            price. You will not receive any information about the true sales
            price or the AI{"’"}s predicted sales price. Participants performing
            well in this task have the chance to win a gift card.
          </p>

          <p>
            On the top of the screen you will see{" "}
            <strong>
              your score, ranging from 0 to 100. You will start with a score of
              100
            </strong>
