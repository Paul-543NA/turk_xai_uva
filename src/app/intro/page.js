      ...
      <div className="space-y-2">
        <div className="form-control">
          <p className="text-lg mb-4">
            In this experiment we are looking at how good humans and AI are at{" "}
            <strong>predicting the sales price of houses</strong>.
          </p>
          <p className="text-lg mb-4">
            The <strong>data</strong> we are using stems from Utrecht, which is
            a city in the Netherlands. Utrecht has a population of roughly
            370,000 people and with that is one of the biggest cities in the
          ...
          <p className="text-base mb-4">
            The set-up of this experiment is as follows: you will go through{" "}
            <strong>three phases</strong>, each with their own instructions. The
            instructions will be shown to you at the start of each phase.{" "}
            <strong>You can revisit the instructions</strong> for the respective
            phase at any time during the experiment by clicking on the{" "}
