    ...
    <div className="hero bg-base-200 min-h-screen">
      <div className="hero-content text-center">
        <div className="max-w-lg">
          <h1 className="text-5xl font-bold dark:text-gray-300">Hello Buki!</h1>
          <p className="py-8 text-xl">
            You are about to take part in a study of human AI collaboration (we
            know you like that). We are very excited to count you as one of our
            participants! It will only take a few minutes and if you do well you
            might even win a gift card!
          </p>
